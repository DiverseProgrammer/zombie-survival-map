function initMap() {
	...
	map = new google.maps.Map(document.getElementById('map'), {
		center: {
			lat: 26.102056865379204,
			lng: -80.3907237202355,
		},
		zoom: 18,
		mapId: ' 3075da77223e48ef',
